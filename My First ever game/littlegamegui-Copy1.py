 ...
 "cells": [
  {
   "cell_type": "code",
   "execution_count": 5,
   "id": "eea2d1d7-cbd6-44a1-a533-e803e1c30f26",
   "metadata": {
    "tags": []
   },
   "outputs": [],
   "source": [
    ...
    "# for the killstreak, add subtypes and update them in mages and grandmages. \n",
    "from tkinter import*\n",
    ...
    "\n",
    "f = 'Fireball = 4 Energy cost, 6 HP damage'\n",
    "l = 'Water Surge = 5 Energy cost, 8 HP damage'\n",
    "w = 'Lightning Strike = 8 Energy cost, 10 HP damage'\n",
    "s = 'Abyssal Lifesteal = 6 Energy cost, 4 HP damage, +10 HP'\n",
    "p = 'Abyssal Strike = +8 Energy, 5 HP damage'\n",
    "a = 'Abyssal Blast = 3 Energy cost, 3 HP damage, +1 Abyssal Charge'\n",
    "\n",
    "\n",
    "completechoices = f+'\\n'+'\\n'+l+'\\n'+'\\n'+w+'\\n'+'\\n'+s+'\\n'+'\\n'+p+'\\n'+'\\n'+a\n",
    "energychoices = words+'\\n'+words1\n",
    ...
    "            content.insert(INSERT,'\\n')\n",
    "            content.insert(INSERT,'\\n')\n",
    "            content.insert(INSERT,spellchoices)    \n",
    ...
    "        content.insert(INSERT,'\\n')\n",
    "        content.insert(INSERT,'You absorb the energy of the {grandmage}'.format(grandmage=self.bossname))\n",
    "        content.insert(INSERT,'\\n')\n",
    "        content.insert(INSERT,'You strike fear into the hearts of your enemies')\n",
    "        content.insert(INSERT,'\\n')\n",
    "        content.insert(INSERT,'You absorb the original 20 energy of the {grandmage}, and you feel empowered'.format(grandmage=self.bossname))\n",
    "        \n",
    "        \n",
    "        \n",
    ...
    "            content.insert(INSERT,'\\n')\n",
    "            content.insert(INSERT,'You lose 5 energy')\n",
    "        \n",
    "            if self.life <= 0 and self.bossalive != 'dead' and self.bosslife > 0:\n",
    "                self.life = 0\n",
    "                lifenum.configure(text=''+ str(self.life))\n",
    ...
    "            content.insert(INSERT,'\\n')\n",
    "            content.insert(INSERT,'\\n')\n",
    "            content.insert(INSERT,'You absorb 1 energy from the Light Mage')\n",
    "            self.counter += 1\n",
    "            self.light += 1\n",
    "            self.mages += 1\n",
    "            self.killstreak()\n",
    ...
    "            wisdom.insert(INSERT,'\\n')\n",
    "            wisdom.insert(INSERT,'\\n')\n",
    "            wisdom.insert(INSERT,'You do not gain an Abyssal charge')\n",
    "\n",
    "            content.insert(INSERT,'\\n')\n",
    "            content.insert(INSERT,'\\n')\n",
    ...
    "            wisdom.insert(INSERT,'\\n')\n",
    "            wisdom.insert(INSERT,'\\n')\n",
    "            wisdom.insert(INSERT,'You gain 3 energy ')\n",
    "                           \n",
    "\n",
    "            content.insert(INSERT,'\\n')\n",
    "            content.insert(INSERT,'\\n')\n",
    ...
    "            content.insert(INSERT,'\\n')\n",
    "            content.insert(INSERT,'\\n')\n",
    "            content.insert(INSERT,'You gain 3 energy from the Elemental mage')\n",
    "            self.counter += 1\n",
    "            self.elemental += 1\n",
    "            self.mages += 1\n",
    "            self.killstreak()\n",
    ...
    "            wisdom.insert(INSERT,'\\n')\n",
    "            wisdom.insert(INSERT,'\\n')\n",
    "            wisdom.insert(INSERT,'You deal 5 life damage to the {grandmage}'.format(grandmage=self.bossname))\n",
    "            self.boss()\n",
    "        \n",
    ...
    "            wisdom.insert(INSERT,'\\n')\n",
    "            wisdom.insert(INSERT,'You gain 5 energy from the battle')\n",
    "            self.energy += 5\n",
    "            energynum.configure(text='' + str(self.energy))  \n",
    "      \n",
    "            content.insert(INSERT,'\\n')\n",
    ...
    "            content.insert(INSERT,'\\n')\n",
    "            content.insert(INSERT,'You absorb 5 energy from the Darkness Mage')\n",
    "            abyssalentry.delete('1.0',END)\n",
    "            abyssalentry.insert(INSERT,'The battle is concluded')\n",
    "            self.counter += 1\n",
    "            self.mages += 1\n",
    "            self.darkness += 1\n",
    "            self.killstreak()\n",
    ...
    "            content.insert(INSERT,'\\n')\n",
    "            content.insert(INSERT,'You absorb 5 energy from the Chaos mage')\n",
    "            self.counter += 1\n",
    "            self.chaos += 1\n",
    "            self.mages += 1\n",
    "            self.killstreak()\n",
    ...
    "            wisdom.insert(INSERT,'\\n')\n",
    "            wisdom.insert(INSERT,'\\n')\n",
    "            wisdom.insert(INSERT,'You deal 5 energy damage to the {grandmage}'.format(grandmage=self.bossname))\n",
    "            if self.bossenergy < 0:\n",
    "                self.bossenergy = 0\n",
    "            self.boss()\n",
    "        \n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 6,
   "id": "1c937637-d57c-47e3-8a08-31d36f912baa",
   "metadata": {},
   "outputs": [],
   "source": [
    "gael = Decoretum()"
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 7,
   "id": "e1f4c51f-fcff-4657-837c-cc933cb08ae5",
   "metadata": {},
   "outputs": [],
   "source": [
    "game = Tk()\n",
    ...
    "\n",
    "powerlabel = Label(game, text = 'Decoretum\\'s Power Status ') #self.name\n",
    "powerlabel.grid(row = 0, column=0)\n",
    "\n",
    "\n",
    "fireball = Button(game,text='Fireball',command=gael.fireball) #Fireball skills and effects\n",
    "fireball.grid(row=1,column=3)\n",
    "\n",
    "water = Button(game,text='Water Surge',command=gael.water) #Water skills and effects\n",
    "water.grid(row=2,column=3)\n",
    "\n",
    "lightning = Button(game,text='Lightning Strike',command=gael.lightning) #Lightning strike skills and effects\n",
    "lightning.grid(row=3,column=3)\n",
    "\n",
    "lifesteal = Button(game,text='Abyssal Lifesteal',command=gael.lifesteal) #leech life\n",
    "lifesteal.grid(row=4,column=3)\n",
    "\n",
    "abyssalstrike = Button(game,text='Abyssal Strike',command=gael.abyssalstrike) #Abyssal strike\n",
    "abyssalstrike.grid(row=5,column=3)\n",
    "\n",
    "abyssalblast = Button(game,text='Abyssal Blast',command=gael.abyssalblast) #Abyssal blast\n",
    "abyssalblast.grid(row=6,column=3)\n",
    "\n",
    "lifelabel = Label(game,text= 'HP')\n",
    "lifelabel.grid(row=1,column=0,sticky=N)\n",
    "\n",
    "lifenum = Label(game,text=gael.life)\n",
    "lifenum.grid(row=1,column=1,sticky=N)  \n",
    "\n",
    "energylabel = Label(game,text = 'Energy:')\n",
    ...
    "\n",
    "abyssalentry = ScrolledText(game,width=30,height=15)\n",
    "abyssalentry.delete('1.0',END)\n",
    ...
    "\n",
    "abyssalbutton = Button(game,text='Input Insights', command=gael.insight)\n",
    "abyssalbutton.grid(row=9, column=6)\n",
    "\n",
    "lists = Label(game,text=completechoices)\n",
    "lists.grid(row=0,column=7,rowspan=5)\n",
    "\n",
    "content = ScrolledText(game,width=80,height=20) #All the events happening\n",
    ...
    "content.insert(INSERT,'\\n')\n",
    "content.insert(INSERT,'\\n')\n",
    "content.insert(INSERT,'After you run the code, restart the kernel')\n",
    "content.configure(state='normal')\n",
    "content.grid(row=10,column=0,columnspan=5,rowspan=10,sticky=W)\n",
    "\n",
    "battle = Button(game,text = 'Battle through the land of Bladespire', command=gael.battle)\n",
    "battle.grid(row = 20,column=0)\n",
    "\n",
    "game.mainloop()"
   ]
  },
  {
   ...
   "id": "a4a31b5c-a4f2-40f2-96d3-557d2fb73c3b",
   "metadata": {},
   "outputs": [],
   "source": []
  }
